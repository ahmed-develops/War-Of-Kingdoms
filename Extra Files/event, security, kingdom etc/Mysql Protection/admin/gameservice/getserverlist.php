...
$logdir = HTDOCS_ROOT . '/data/log/getserverlist/';
...
function choseServer($playerCountry, $gmFlag, $terminal, $deviceId){
	file_put_contents("/tmp/user.log", "playerCountry:".$playerCountry.", gmFlag:".$gmFlag.", terminal:".$terminal.", deviceId:".$deviceId."\n", FILE_APPEND);
...
// 	}
	...
	if($serverId === null && !empty($serverRatioConf)) {
		...
		$idx = randItemWithWeight($valueList);
		$serverId = $keyList[$idx];
		file_put_contents("/tmp/user.log", "bbbb".$serverId."\n", FILE_APPEND);
	}
	...
	if($serverId !== null) {
		...
		// $serverObj["uuid"] = "357070056547294-3423BA88335F1450704662378";
		// $serverObj["gameUid"] = "52302353001157";
		// $serverObj["buildCode"] = "79aae83f77178962766495932d4c635f";
		// $serverObj["gameUserLevel"] = "1";
